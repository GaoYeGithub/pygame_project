...
def draw_setting():
    ...
    draw_addiction_meter()

def generate_bananas():
...
def update_monkey():
    ...
    if addiction_level >= max_addiction:
        game_over_display("Banana Overdose!")

def game_over_display(reason="Time's Up!"):
